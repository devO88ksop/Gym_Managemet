                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                ...
                                <h2 class="text-white display-1">BlAH GYM</h2>
                            </div>
                        </div>
                        <div class="col-xl-10 col-lg-10 col-md-10">
                            <div class="menu-main d-flex align-items-center justify-content-end">
                                ...
                                <div class="main-menu f-right d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a href="{{ url('/promo/create') }}">Promotions</a></li>
                                            <li><a href="{{ url('/promo') }}">Promotion List</a></li>
                                ...
                                <div class="header-right-bCLIENT FEtn f-right d-none d-lg-block ml-30">
                                    <a href="/newmember" class="btn header-btn">became a member</a>
                                </div>
                            </div>
                        </div>
                        <!-- Mobile Menu -->
